...
export class BasisArbitrageBot {
  ...
  async start(): Promise<void> {
    ...
    this.interval = setInterval(async () => {
      try {
        ...
        console.error('Error executing basis arbitrage strategy:', error);
      }
  ...
  private async executeStrategy(): Promise<void> {
    try {
      // Implement basis arbitrage strategy logic here
      ...
      console.error('Error in basis arbitrage strategy:', error);
    }
  }
