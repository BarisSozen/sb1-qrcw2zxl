...
export class PerpetualArbitrageBot {
  ...
  async start(): Promise<void> {
    ...
    this.interval = setInterval(async () => {
      try {
        ...
        console.error('Error executing perpetual arbitrage strategy:', error);
      }
  ...
  private async executeStrategy(): Promise<void> {
    try {
      // Implement perpetual arbitrage strategy logic here
      ...
      console.error('Error in perpetual arbitrage strategy:', error);
    }
  }
