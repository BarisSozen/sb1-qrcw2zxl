/*
  # Update Sales Representatives Schema

  1. Changes
    - Add unique constraint on email
    - Add default values for commission rates
    - Add payment details structure
*/

-- Add unique constraint to sales_reps email if it doesn't exist
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint 
    WHERE conname = 'sales_reps_email_key'
  ) THEN
...
-- Insert or update sample sales representatives
